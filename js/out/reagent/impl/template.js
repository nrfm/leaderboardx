...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__7737__auto__,writer__7738__auto__,opt__7739__auto__){
return cljs.core._write(writer__7738__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__23311 = o;
(G__23311[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__23312__delegate = function (args){
...
while (G__23313__i < G__23313__a.length) {G__23313__a[G__23313__i] = arguments[G__23313__i + 0]; ++G__23313__i;}
  args = new cljs.core.IndexedSeq(G__23313__a,0);
} 
return G__23312__delegate.call(this,args);};
...
return G__23312__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__7073__auto__ = cljs.core.some_QMARK_(jsprops);
if(and__7073__auto__){
var and__7073__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__23320 = jsprops;
(G__23320["defaultValue"] = value);

(G__23320["onChange"] = ((function (G__23320,v,value,on_change){
return (function (p1__23317_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__23317_SHARP_);
});})(G__23320,v,value,on_change))
);

(G__23320["ref"] = ((function (G__23320,v,value,on_change){
return (function (p1__23318_SHARP_){
return (this$["cljsInputElement"] = p1__23318_SHARP_);
});})(G__23320,v,value,on_change))
);
...
var vec__23327 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23327,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23327,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23327,(2),null);
...
var jsprops = ({"argv": v});
var temp__6757__auto___23332 = reagent.impl.template.key_from_vec(v);
if((temp__6757__auto___23332 == null)){
} else {
var key_23333 = temp__6757__auto___23332;
(jsprops["key"] = key_23333);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__23335 = (new reagent.impl.template.NativeWrapper());
(G__23335["name"] = c);
...
var G__23337 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__23337) : reagent.impl.template.as_element.call(null,G__23337));
} else {
...
var len__8301__auto___23343 = arguments.length;
var i__8302__auto___23344 = (0);
while(true){
if((i__8302__auto___23344 < len__8301__auto___23343)){
args__8308__auto__.push((arguments[i__8302__auto___23344]));

var G__23345 = (i__8302__auto___23344 + (1));
i__8302__auto___23344 = G__23345;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__8309__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq23341){
var G__23342 = cljs.core.first(seq23341);
var seq23341__$1 = cljs.core.next(seq23341);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__23342,seq23341__$1);
});
...
break;
default:
var G__23349 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__23349;
continue;
...
var n__8101__auto___23352 = a.length;
var i_23353 = (0);
while(true){
if((i_23353 < n__8101__auto___23352)){
(a[i_23353] = reagent.impl.template.as_element((a[i_23353])));

var G__23354 = (i_23353 + (1));
i_23353 = G__23354;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__8101__auto___23355 = a.length;
var i_23356 = (0);
while(true){
if((i_23356 < n__8101__auto___23355)){
var val_23357 = (a[i_23356]);
if((cljs.core.vector_QMARK_(val_23357)) && ((reagent.impl.template.key_from_vec(val_23357) == null))){
(o["no-key"] = true);
} else {
}

(a[i_23356] = reagent.impl.template.as_element(val_23357));

var G__23358 = (i_23356 + (1));
i_23356 = G__23358;
continue;
} else {
}
...
var ctx = ({});
var vec__23362 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23362,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__23362,(1),null);
...
var G__23366 = (cljs.core.count(argv) - first_child);
switch (G__23366) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__23366){
