...
if((i < len)){
var k = (ks[i]);
var G__23226 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__23227 = (i + (1));
m = G__23226;
i = G__23227;
continue;
...
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__23231 = c;
var G__23231__$1 = (((G__23231 == null))?null:G__23231.prototype);
if((G__23231__$1 == null)){
return null;
} else {
return (G__23231__$1["reagentRender"]);
}
})()));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (cljs.core.some_QMARK_((function (){var G__23235 = c;
var G__23235__$1 = (((G__23235 == null))?null:G__23235.prototype);
if((G__23235__$1 == null)){
return null;
} else {
return (G__23235__$1["render"]);
}
})()));
});
...
var G__23239 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__23239) : reagent.impl.component.as_element.call(null,G__23239));
};
...
var _STAR_current_component_STAR_23246 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_23246;
}});
...
var G__23254 = (((key instanceof cljs.core.Keyword))?key.fqn:null);
switch (G__23254) {
...
return ((function (G__23254){
return (function reagent$impl$component$custom_wrapper_$_getInitialState(){
var c = this;
var G__23257 = reagent.impl.component.state_atom(c);
var G__23258 = f.call(c,c);
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__23257,G__23258) : cljs.core.reset_BANG_.call(null,G__23257,G__23258));
});
;})(G__23254))
...
var or__7085__auto__ = reagent.impl.util._STAR_always_update_STAR_;
...
var c = this;
var G__23260_23262 = (c["cljsRatom"]);
if((G__23260_23262 == null)){
} else {
reagent.ratom.dispose_BANG_(G__23260_23262);
}
...
if(cljs.core.truth_((function (){var and__7073__auto__ = wrap;
...
var renders_23265 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_23266 = cljs.core.first(cljs.core.vals(renders_23265));
if((cljs.core.count(renders_23265) > (0))){
} else {
...
if(((1) === cljs.core.count(renders_23265))){
} else {
...
if(cljs.core.ifn_QMARK_(render_fun_23266)){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([render_fun_23266], 0)))].join('')),cljs.core.str("\n"),cljs.core.str("(ifn? render-fun)")].join('')));
}


var render_fun = (function (){var or__7085__auto__ = cljs.core.cst$kw$reagentRender.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__7085__auto__)){
return or__7085__auto__;
} else {
...
var render_fun__$1 = (function (){var or__7085__auto__ = render_fun;
if(cljs.core.truth_(or__7085__auto__)){
return or__7085__auto__;
} else {
...
var name = [cljs.core.str((function (){var or__7085__auto__ = cljs.core.cst$kw$displayName.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__7085__auto__)){
return or__7085__auto__;
} else {
...
var name__$1 = (function (){var G__23264 = name;
switch (G__23264) {
case "":
...
var elem = (function (){var G__23275 = (function (){var or__7085__auto__ = (function (){var G__23277 = c;
if((G__23277 == null)){
return null;
} else {
return (G__23277["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__7085__auto__)){
return or__7085__auto__;
...
return (G__23275["_currentElement"]);
}
})();
var name = (function (){var G__23278 = elem;
var G__23278__$1 = (((G__23278 == null))?null:(G__23278["type"]));
if((G__23278__$1 == null)){
return null;
} else {
return (G__23278__$1["displayName"]);
}
})();
var path = (function (){var G__23279 = elem;
var G__23279__$1 = (((G__23279 == null))?null:(G__23279["_owner"]));
var G__23279__$2 = (((G__23279__$1 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__23279__$1) : reagent.impl.component.component_path.call(null,G__23279__$1)));
if((G__23279__$2 == null)){
return null;
} else {
return [cljs.core.str(G__23279__$2),cljs.core.str(" > ")].join('');
}
})();
...
var n = (function (){var or__7085__auto__ = reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__7085__auto__)){
return or__7085__auto__;
} else {
var G__23281 = c;
var G__23281__$1 = (((G__23281 == null))?null:G__23281.constructor);
if((G__23281__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__23281__$1);
}
}
})();
