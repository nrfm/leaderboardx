...
var or__7085__auto__ = reagent.dom.server.imported = require("react-dom/server");
...
var _STAR_non_reactive_STAR_23371 = reagent.impl.util._STAR_non_reactive_STAR_;
...
}finally {reagent.impl.util._STAR_non_reactive_STAR_ = _STAR_non_reactive_STAR_23371;
}});
/**
...
var _STAR_non_reactive_STAR_23373 = reagent.impl.util._STAR_non_reactive_STAR_;
reagent.impl.util._STAR_non_reactive_STAR_ = true;

try{return (reagent.dom.server.module()["renderToStaticMarkup"])(reagent.impl.template.as_element(component));
}finally {reagent.impl.util._STAR_non_reactive_STAR_ = _STAR_non_reactive_STAR_23373;
}});
