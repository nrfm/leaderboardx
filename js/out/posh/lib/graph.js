...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.array_seq([cljs.core.PersistentArrayMap.fromArray([item_k,new cljs.core.PersistentArrayMap(null, 2, [cljs.core.cst$kw$inputs,cljs.core.PersistentHashSet.EMPTY,cljs.core.cst$kw$outputs,cljs.core.PersistentHashSet.EMPTY], null)], true, false),graph], 0));
});
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(graph,k,(function (p1__34330_SHARP_){
return cljs.core.disj.cljs$core$IFn$_invoke$arity$2(p1__34330_SHARP_,dep_k);
}));
});
posh.lib.graph.remove_item = (function posh$lib$graph$remove_item(graph,item_k){
var temp__6751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(graph,item_k);
if(cljs.core.truth_(temp__6751__auto__)){
var map__34333 = temp__6751__auto__;
...
var inputs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34333__$1,cljs.core.cst$kw$inputs);
var outputs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34333__$1,cljs.core.cst$kw$outputs);
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (map__34333,map__34333__$1,inputs,outputs,temp__6751__auto__){
return (function (gr,output_k){
return posh.lib.graph.remove_output(gr,output_k,item_k);
});})(map__34333,map__34333__$1,inputs,outputs,temp__6751__auto__))
